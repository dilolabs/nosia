...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends $4040acfd8584338d$export$2e2bcd8739ae039 {
    ...
    getExistingFallback() {
        ...
        for (let t of ["div", "form"]) {
            var e;
            if ((e = getFallback(this.element.getElementsByTagName(t))))
                return e;
        }
    }
    setupEventListeners() {
    ...
    _addFilesFromDirectory(e, t) {
        ...
        let errorHandler = (e) =>
            $3ed269f2f0fb224b$var$__guardMethod__(console, "log", (t) =>
                t.log(e),
            );
        var readEntries = () =>
            i.readEntries((e) => {
        ...
        return this.createThumbnail(e, t, i, s, true, (t, i) => {
            if (null == i) return l(e);
            {
                ...
                ("image/jpeg" !== t && "image/jpg" !== t) ||
                    (s = $3ed269f2f0fb224b$var$ExifRestore.restore(
                        e.dataURL,
                        s,
                    ));
                return l(
                    $3ed269f2f0fb224b$export$2e2bcd8739ae039.dataURItoBlob(s),
                );
            }
        });
    }
    ...
    _uploadData(t, i) {
        ...
        if (this.options.binaryBody) {
            ...
            this.options.uploadMultiple &&
                this.emit("sendingmultiple", t, s, e);
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.discover = function () {
    ...
    return (() => {
        ...
        for (let i of e)
            false !==
            $3ed269f2f0fb224b$export$2e2bcd8739ae039.optionsForElement(i)
    ...
    for (let l of t) {
        ...
        if ("." === l.charAt(0)) {
            if (
                ...
                e.name
                    .toLowerCase()
                    .indexOf(l.toLowerCase(), e.name.length - l.length)
            )
                return true;
        } else if (/\/\*$/.test(l)) {
